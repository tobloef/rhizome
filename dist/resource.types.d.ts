...
export type ResourceStatus = ("unevaluated" | "evaluating" | "evaluated" | "invalidated" | "errored" | "destroyed");
export type ResourceEvaluator<Type, Dependencies extends DependencyMap, Errorables extends DependencyKeys<Dependencies>> = (dependencies: KeysOptional<Dependencies, Errorables>) => EvaluationResult<Type> | Promise<EvaluationResult<Type>>;
...
export type OnInvalidatedCallback<Res extends AnyResource = AnyResource> = (params: {
    resource: Res;
